  ...
  return (
    <SForm onSubmit={(e: any) => handleNewParameter(e)}>
      <SFieldset>
        ...
        >
          <option selected style={{ fontSize: '16px', color: '#000000' }}>
            Escolha o parâmetro
          </option>
          <option
            value="pluviometro"
      ...
      <SFieldset>
        ...
        >
          ...
          <option value="mm" style={{ fontSize: '16px' }}>
            mm
          </option>
          <option value="ºC" style={{ fontSize: '16px' }}>
            ºC
          </option>
          <option value="km/h" style={{ fontSize: '16px' }}>
            km/h
          </option>
          <option value="%" style={{ fontSize: '16px' }}>
            %
          </option>
          <option value="Pa" style={{ fontSize: '16px' }}>
            Pa
          </option>
          <option value="outros" style={{ fontSize: '16px' }}>
            Outros
          </option>
        </SFieldsetSelect>
      </SFieldset>
      ...
      <SFieldset>
        ...
        <CustomInput
          placeholder="Digite a margem de erro"
      ...
      <SFieldset>
        ...
        >
          ...
          <option value="temp" style={{ fontSize: '16px', color: '#000000' }}>
            Temperatura
          </option>
          <option value="umid" style={{ fontSize: '16px', color: '#000000' }}>
            Umidade
          </option>
          <option value="v_vent" style={{ fontSize: '16px', color: '#000000' }}>
            Velocidade do Vento
          </option>
          <option value="d_vent" style={{ fontSize: '16px', color: '#000000' }}>
            Direção do Vento
          </option>
          <option value="pluv" style={{ fontSize: '16px', color: '#000000' }}>
            Milimetros
          </option>
        </SFieldsetSelect>
      </SFieldset>
